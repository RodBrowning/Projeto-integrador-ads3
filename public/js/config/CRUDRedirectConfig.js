		...
		switch(operacao)
			{
				case 'salvar-funcionario':
						xmlhttp.open('post', `./pages/PopUpsContent/config/funcionarios/CRUDFuncionarios/salvar_funcionario.php?nome_func=${args[0]}&cpf=${args[1]}&tipo_acesso=${args[2]}&email=${args[3]}&senha=${args[4]}&senhaConfirm=${args[5]}`,true);
					break;
