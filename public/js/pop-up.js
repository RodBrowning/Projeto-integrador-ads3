		...
		switch(tipo_operacao)
			{
				...
				case 'credito':
					...
					break;
				case 'confirm-func':
						xmlhttp.open('post', `./pages/PopUpsContent/config/funcionarios/novo_funcionario.php?nome_func=${args[0]}&cpf=${args[1]}&tipo_acesso=${args[2]}&email=${args[3]}&senha=${args[4]}&senhaConfirm=${args[5]}`,true);				
					break;
				case 'permission':
				...
				case 'update-valores-horas':
						xmlhttp.open('post', `./pages/PopUpsContent/config/valores/update_valores_horas.php?primeiraHora=${args[0]}&demaisHoras=${args[1]}`,true);													
					break;
				case 'update-valores-diario':
						xmlhttp.open('post', `./pages/PopUpsContent/config/valores/update_valores_diario.php?valorDiario=${args[0]}`,true);													
					break;
				case 'update-valores-mensal':
						xmlhttp.open('post', `./pages/PopUpsContent/config/valores/update_valores_mensal.php?valorMensal=${args[0]}`,true);													
					break;		
				default :
						xmlhttp.open();
					break;
