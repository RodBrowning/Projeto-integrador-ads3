	...
	<fieldset onloadeddata="fill()">
		<legend>Novo Funcionario</legend>			
			<div class="col-md-11 marginAuto divLancamento marginAuto">
				...
				<button onclick="Crud('salvar-funcionario',<?php echo "'".$_REQUEST['nome']."'"?>,<?php echo "'".$_REQUEST['cpf']."'"?>,<?php echo "'".$_REQUEST['tipo_acesso']."'"?>,<?php echo "'".$_REQUEST['email']."'"?>,<?php echo "'".$_REQUEST['senha']."'"?>,<?php echo "'".$_REQUEST['senhaConfirm']."'"?>)" class="my-btn my-btn-success mb-3">Debitar</button>				
